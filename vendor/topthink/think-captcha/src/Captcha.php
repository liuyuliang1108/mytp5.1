    ...
    public function entry($id = '')
    {
        ...
        if ($this->useZh) {
            ...
            for ($i = 0; $i < $this->length; $i++) {
                ...
                $codeNX += mt_rand($this->imageW/($this->length+1) * 0.8, $this->imageW/($this->length+1) * 1.1);
                $codeNY=($this->imageH-($this->fontSize)/72*96)/2+$this->fontSize;
                imagettftext($this->im, $this->fontSize, mt_rand(-40, 40), $codeNX, $codeNY, $this->color, $this->fontttf, $code[$i]);
            }
        }
