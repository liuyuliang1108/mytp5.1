...
jQuery.event = {
	...
	add: function( elem, types, handler, data, selector ) {
		...
		// Don't attach events to noData or text/comments nodes (but allow plain objects)
		if ( !elemData ) {
			return;
		}
...
// BaseModel "constructor" for jQuery.ajaxPrefilter and jQuery.ajaxTransport
...
// BaseModel inspection function for prefilters and transports
