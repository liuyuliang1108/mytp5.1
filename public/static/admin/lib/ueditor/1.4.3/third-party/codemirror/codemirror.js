    ...
    function inText(stream, state) {
        ...
        if (ch == "<") {
            if (stream.eat("!")) {
                ...
                else if (stream.match("--")) return chain(inBlock("comments", "-->"));
...
CodeMirror.defineMode("css", function(config) {
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            else if (context == "{" && type != "comments") state.stack.push("rule");
            return style;
        },
