<?php /*a:3:{s:78:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\admin\admin_list.html";i:1553086003;s:72:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_meta.html";i:1553677538;s:74:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_footer.html";i:1553677291;}*/ ?>
﻿
    <!DOCTYPE HTML>
    <html>
    <head>
...
<div class="page-container">
	<div class="text-c"> 日期范围：
		<input type="text" name="start_time" id="countTimestart" onfocus="selecttime(1)" value="<?php echo htmlentities((isset($start_date) && ($start_date !== '')?$start_date:date('Y-m-d h:i:s',strtotime('-1 month')))); ?>" size="17" class="date" readonly> -
		<input type="text" name="end_time" id="countTimeend" onfocus="selecttime(2)" value="<?php echo htmlentities((isset($end_time) && ($end_time !== '')?$end_time:date('Y-m-d h:i:s',time()))); ?>" size="17"  class="date" readonly>
		<button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜用户</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','http://tp5.1.com/admin/admin/adminAdd.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
