<?php /*a:6:{s:76:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\category\index.html";i:1554373199;s:71:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\base.html";i:1554373199;s:72:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_meta.html";i:1554373199;s:74:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_header.html";i:1554373199;s:72:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_menu.html";i:1554373199;s:74:"C:\phpStudy\PHPTutorial\WWW\tp5.1\application\admin\view\base\_footer.html";i:1554373199;}*/ ?>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/http://tp5.1.com/static/admin/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<?php if(is_array($vo['parent_id']) || $vo['parent_id'] instanceof \think\Collection || $vo['parent_id'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['parent_id'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($i % 2 );++$i;?>
					<li><a data-href="http://tp5.1.com/admin/<?php echo htmlentities($vi['url']); ?>" data-title="<?php echo htmlentities($vi['name']); ?>" href="javascript:void(0)"><?php echo htmlentities($vi['name']); ?></a></li>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="admin.html"></iframe>
        </div>
    </div>
</section>
<!--分页栏-->
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="http://tp5.1.com/static/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
